...
## Komodo Dragon (7.5) → Godzilla (9.2) in one session. Path to Bolt continues.
...
### THE KAI DIAGNOSTIC (what separates Komodo Dragon from Godzilla)
| Komodo Dragon (writing ABOUT) | Godzilla (writing FROM) |
|----------------------|---------------------|
...
- Gecko/Iguana = less than 1%, incapable
- Komodo Dragon = common, bumps into yes, repelling beyond capability
- Crocodile = 99th percentile, first meaningful yes capability
- Godzilla = 99.999, scaling begins

...
DEFAULT_COLOSSEUM_ROOT = REPO_ROOT / "workspaces" / "prime" / "Projects" / "colosseum"
DEFAULT_MAIN_DB = str(DEFAULT_COLOSSEUM_ROOT / "colosseum.db")
DEFAULT_DOMAINS_ROOT = str(DEFAULT_COLOSSEUM_ROOT / "domains")

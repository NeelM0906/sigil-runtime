...
COLOSSEUM_ROOT = Path(os.getenv("COLOSSEUM_ROOT", str(REPO_ROOT / "workspaces" / "prime" / "Projects" / "colosseum")))
MAIN_DB = str(COLOSSEUM_ROOT / 'colosseum.db')
DOMAIN_DB_TEMPLATE = str(COLOSSEUM_ROOT / 'domains' / '{domain}' / 'colosseum.db')
...
You speak FIRST. Open strong and establish your position."""
    ...
    try:
        response = httpx.post(
            ...
            json={
                'model': os.environ.get("BOMBA_MODEL_ID", 'anthropic/claude-opus-4.6'),
                'messages': messages,
                'max_tokens': 300,
                'temperature': 0.8
            },

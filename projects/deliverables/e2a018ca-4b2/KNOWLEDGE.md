...
### Recovery Operational Specification v1.0 (2026-03-21)

**Full spec saved to:** `RECOVERY_OPERATIONAL_SPEC_v1.md` (21KB)

**7 Case Types:** CHURN_PREVENTION, REVENUE_RECOVERY, ACCOUNT_RESCUE, RETENTION_CAMPAIGN, PARTNERSHIP_RECOVERY, REACTIVATION, ESCALATION

**Each case type has defined workflow stages** with entry/exit criteria, max dwell times, and terminal states (positive + negative outcomes).

**7 KPIs tracked:** Revenue Recovered ($), Recovery Rate (%), Time-to-Resolution (hrs), Client Satisfaction (1-5), SLA Compliance (%), Revenue at Risk ($), Win-Back Rate (%)

**4-tier Priority Framework:** CRITICAL (>$50K/enterprise/SLA breach) → HIGH ($10K-$50K/referral network/renewal in 30d) → ME